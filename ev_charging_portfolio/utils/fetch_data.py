...
# OCM CountryID → ISO code mapping (compact API mode returns IDs only)
COUNTRY_ID_MAP = {
    87:  "DE",  # Germany
    19:  "AT",  # Austria
    ...
    for s in raw:
        try:
            ...
            records.append({
                ...
                "country_code":     COUNTRY_ID_MAP.get(addr.get("CountryID")),
                "city":             addr.get("Town"),
...
if __name__ == "__main__":
    ...
    print("\nSample:")
    print(df[["country_code", "city", "max_power_kw", "speed_category", "num_points"]].head(10))
